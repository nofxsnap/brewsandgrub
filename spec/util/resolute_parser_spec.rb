...
RSpec.describe ResoluteParser do
  SPEC_BREWERY_EVENT_HOURS = "4:00pm-8:00pm"

  before(:all) do
    @brewery = create(:resolute)
  ...
  before(:each) do
    ...
    @brewery.update_attribute(:remote_schedule_endpoint, "#{Rails.root}/spec/util/dataz/resolute.html")
  end
  ...
  describe '#test_the things' do
    it "should get food truck for the day and create a new food truck" do
      ...
      expect(food_truck.name).to eq("Mac 'N Noodles")
